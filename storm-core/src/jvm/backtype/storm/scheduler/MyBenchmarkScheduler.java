...
public class MyBenchmarkScheduler implements IScheduler {
    ...
    public MyBenchmarkScheduler()
    {
        super();
        LOG = org.apache.log4j.Logger.getLogger(MyBenchmarkScheduler.class);
    ...
    public void schedule(Topologies topologies, Cluster cluster) {
        ...
        LOG.info("**************WELCOME TO MyBenchmarkScheduler **************");
    ...
    private void scheduleATopology(TopologyDetails topology, Cluster cluster)
    {
        ...
        //assign spout and final bolt to same supervisor
        String spoutName = "spout";
        String finalBoltName = "bolt2";
        SupervisorDetails firstSupervisor = new ArrayList<SupervisorDetails>(cluster.getSupervisors().values()).get(0);
        for (String k : needsSchedulingComponentToExecutors.keySet()) {
            if(k.equals(spoutName) || k.equals(finalBoltName)){
                ...
                for(ExecutorDetails executor: executors) {
                    ...
                    List<WorkerSlot> availableSlots = cluster.getAvailableSlots(firstSupervisor);
        ...
        needsSchedulingComponentToExecutors = cluster.getNeedsSchedulingComponentToExecutors(topology);
